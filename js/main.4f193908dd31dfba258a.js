...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "4f193908dd31dfba258a";
...
/***/ "../node_modules/babel-loader/lib/index.js!./assets/js/modules/app.js":
/*!*******************************************************************!*\
  !*** ../node_modules/babel-loader/lib!./assets/js/modules/app.js ***!
  \*******************************************************************/
...
/***/ "../node_modules/expose-loader/index.js?entry!./assets/js/modules/app.js-exposed":
/*!******************************************************************************!*\
  !*** ../node_modules/expose-loader?entry!./assets/js/modules/app.js-exposed ***!
  \******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["entry"] = __webpack_require__(/*! -!../node_modules/babel-loader/lib!./app.js */ "../node_modules/babel-loader/lib/index.js!./assets/js/modules/app.js");
...
/***/ "../node_modules/imports-loader/index.js?APP=>entry.APP!./assets/js/modules/abstract.class.js":
/*!*******************************************************************************************!*\
  !*** ../node_modules/imports-loader?APP=>entry.APP!./assets/js/modules/abstract.class.js ***!
  \*******************************************************************************************/
/*! no static exports found */
...
/***/ "../node_modules/imports-loader/index.js?APP=>entry.APP!./assets/js/modules/browser.class.js":
/*!******************************************************************************************!*\
  !*** ../node_modules/imports-loader?APP=>entry.APP!./assets/js/modules/browser.class.js ***!
  \******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
(function () {
  ...
  APP.TOOLS.Browser = APP.CORE.Event_Emitter.extend({
    ...
    staticInstantiate: function staticInstantiate() {
      if (APP.TOOLS.Browser.prototype.instance === null) return null;else return APP.TOOLS.Browser.prototype.instance;
    },
    ...
    init: function init(options) {
      ...
      if (this.options.add_classes_to.length) this.add_classes();
      if (this.options.disable_hover_on_scroll) this.disable_hover_on_scroll();
     ...
     */
    start: function start() {
      if (this.listening_to.scroll) this.window.trigger('scroll');
      if (this.listening_to.resize) this.window.trigger('resize');
    },

    /**
     * INIT BREAKPOINTS
     */
    init_breakpoints: function init_breakpoints() {
      this.breakpoints = {};
     ...
     * ADD BREAKPOINTS
     */
    add_breakpoint: function add_breakpoint(breakpoint) {
     ...
     * ADD BREAKPOINTS
     */
    add_breakpoints: function add_breakpoints(breakpoints) {
     ...
     * TEST BREAKPOINTS
     */
    test_breakpoints: function test_breakpoints() {
      // Default to null
      var current_breakpoint = null; // Each breakpoint
      ...
      for (var i = 0, len = this.breakpoints.items.length; i < len; i++) {
        var breakpoint = this.breakpoints.items[i],
            ...
            height = !breakpoint.limits.height; // Width must be tested

        if (!width) {
          // Min
          if (breakpoint.limits.width.extreme === 'min') {
            if ( // Included
            breakpoint.limits.width.included && this.width >= breakpoint.limits.width.value || // Not included
            !breakpoint.limits.width.included && this.width > breakpoint.limits.width.value) width = true;
          } // Max
          else {
              if ( // Included
              breakpoint.limits.width.included && this.width <= breakpoint.limits.width.value || // Not included
        ...
        if (!height) {
          ...
          if (breakpoint.limits.height.extreme === 'min') {
            if ( // Included
            breakpoint.limits.height.included && this.height >= breakpoint.limits.height.value || // Not included
            !breakpoint.limits.height.included && this.height > breakpoint.limits.height.value) height = true;
          } // Max
          else {
              if ( // Included
              breakpoint.limits.height.included && this.height <= breakpoint.limits.height.value || // Not included
     ...
     */
    disable_hover_on_scroll: function disable_hover_on_scroll() {
      var that = this,
          body = $('body');
      ...
      if (window.addEventListener) window.addEventListener('scroll', disable, false);else window.attachEvent('scroll', disable, false);
    },

    /**
     * GET BROWSER
     */
    set_browser: function set_browser() {
      var is = {},
          agent = navigator.userAgent.toLowerCase(); // Detect browser
      ...
      is.ipad = agent.indexOf('ipad') !== -1; // // For use within iPad developer UIWebView
     ...
     */
    set_browser_version: function set_browser_version() {
      this.version = false;
     ...
     * GET MOBILE
     */
    mobile_detection: function mobile_detection() {
      var checker = {};
    ...
    match_media: function match_media(condition) {
      if (!('matchMedia' in window) || typeof condition !== 'string' || condition === '') return false;
    ...
    frame: function frame() {
      ...
      if (keys.length) this.shall_trigger = {};
    }
  });
})();
...
/***/ "../node_modules/imports-loader/index.js?APP=>entry.APP!./assets/js/modules/css.class.js":
/*!**************************************************************************************!*\
  !*** ../node_modules/imports-loader?APP=>entry.APP!./assets/js/modules/css.class.js ***!
  \**************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
(function () {
  ...
  APP.TOOLS.Css = APP.CORE.Abstract.extend({
     ...
     */
    staticInstantiate: function staticInstantiate() {
      if (APP.TOOLS.Css.prototype.instance === null) return null;else return APP.TOOLS.Css.prototype.instance;
    },
    ...
    apply: function apply($target, property, value) {
      if (typeof property === 'undefined' || property === '') console.warn('Wrong property');
      if (typeof value === 'undefined' || value === '') console.warn('Wrong value');
      if (typeof $target === 'undefined' || !$target.length) console.warn('Wrong target');
      if (this.browser.is.IE && this.browser.version < 10) value = value.replace('translateZ(0)', '');

      for (var css = {}, i = 0, len = this.prefixes.length; i < len; i++) {
        var updated_property = this.prefixes[i];
        if (updated_property !== '') updated_property += this.capitalize_first_letter(property);else updated_property = property;
    ...
    capitalize_first_letter: function capitalize_first_letter(text) {
...
/***/ "../node_modules/imports-loader/index.js?APP=>entry.APP!./assets/js/modules/event_emitter.class.js":
/*!************************************************************************************************!*\
  !*** ../node_modules/imports-loader?APP=>entry.APP!./assets/js/modules/event_emitter.class.js ***!
  \************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
(function () {
  ...
  APP.CORE.Event_Emitter = APP.CORE.Abstract.extend({
    ...
    on: function on(name, action) {
      ...
      names = name.split(' '); // Each name

      names.forEach(function (name) {
        name = that.resolve_name(name); // Create tag if not exist

        if (!(that.callbacks[name.tag] instanceof Object)) that.callbacks[name.tag] = {}; // Create action if not exist

        if (!(that.callbacks[name.tag][name.value] instanceof Array)) that.callbacks[name.tag][name.value] = []; // Add action
    ...
    off: function off(name) {
      ...
      names.forEach(function (name) {
        name = that.resolve_name(name); // Remove tag
            ...
            if (name.tag === 'base') {
              ...
              for (var tag in that.callbacks) {
                if (that.callbacks[tag] instanceof Object && that.callbacks[tag][name.value] instanceof Array) {
                  delete that.callbacks[tag][name.value]; // Remove tag if empty

                  if (Object.keys(that.callbacks[tag]).length === 0) delete that.callbacks[tag];
                }
              }
            } // Specified tag
            else if (that.callbacks[name.tag] instanceof Object && that.callbacks[name.tag][name.value] instanceof Array) {
                delete that.callbacks[name.tag][name.value]; // Remove tag if empty

                if (Object.keys(that.callbacks[name.tag]).length === 0) delete that.callbacks[name.tag];
              }
          }
      });
      return this;
    ...
    trigger: function trigger(name, args) {
      ...
      var that = this,
          ...
          result = undefined; // Default args

      if (!(args instanceof Array)) args = [];
      name = that.resolve_name(name); // Clean (need some work)

      name.value = name.value.replace(/[^a-zA-Z0-9 ,\/.]/g, '');
      name.value = name.value.replace(/[,\/]+/g, ' '); // Default tag
     ...
     * TRIGGA NIGGA WUT
     */
    trigga: function trigga(name, args) {
     ...
     * CLEAN NAME
     */
    clean_name: function clean_name(name) {
    ...
    resolve_name: function resolve_name(name) {
      ...
      if (parts.length > 1 && parts[1] !== '') new_name.tag = parts[1];
      return new_name;
    }
  });
})();
...
/***/ "../node_modules/imports-loader/index.js?APP=>entry.APP!./assets/js/modules/header.class.js":
/*!*****************************************************************************************!*\
  !*** ../node_modules/imports-loader?APP=>entry.APP!./assets/js/modules/header.class.js ***!
  \*****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
(function () {
  ...
  APP.COMPONENTS.Header = APP.CORE.Event_Emitter.extend({
     ...
     */
    init_events: function init_events() {
      var that = this; // Toggle click event
      ...
      this.$.projects.on('click touchstart touchend', function (e) {
        ...
        switch (e.type) {
          ...
          case 'touchend':
            ...
            if (distance < 5) go_on = true;
            break;
        }

        if (go_on) {
          var $project = $(this); // Close header

          that.deactivate(); // Trigger
     ...
     * INIT SCROLLBAR
     */
    init_scrollbar: function init_scrollbar() {
      var that = this;
      this.scrollbar = {};
      ...
      this.$.right.bind('move', function () {// that.$.right.addClass( 'scroll-active' );
...
/***/ "../node_modules/imports-loader/index.js?APP=>entry.APP!./assets/js/modules/home.class.js":
/*!***************************************************************************************!*\
  !*** ../node_modules/imports-loader?APP=>entry.APP!./assets/js/modules/home.class.js ***!
  \***************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
(function () {
  ...
  APP.COMPONENTS.Home = APP.CORE.Event_Emitter.extend({
    ...
    init: function init(options) {
      ...
      this.$.main = $('.page.home');
      this.$.projects = this.$.main.find('.line.project'); // this.$.projects_links = this.$.projects.find( 'a.ajax' );
     ...
     */
    init_events: function init_events() {
      var that = this; // Illustrations mouse envets
     ...
     * UPDATE LINE
     */
    update_line: function update_line(index, count, direction) {
      var that = this; // Wave

      if (this.wave.timeout) window.clearTimeout(this.wave.timeout);
      if (this.wave.interval) window.clearInterval(this.wave.interval);
...
/***/ "../node_modules/imports-loader/index.js?APP=>entry.APP!./assets/js/modules/images.class.js":
/*!*****************************************************************************************!*\
  !*** ../node_modules/imports-loader?APP=>entry.APP!./assets/js/modules/images.class.js ***!
  \*****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
(function () {
  ...
  APP.TOOLS.Images = APP.CORE.Abstract.extend({
     ...
     */
    staticInstantiate: function staticInstantiate() {
      if (APP.TOOLS.Images.prototype.instance === null) return null;else return APP.TOOLS.Images.prototype.instance;
    },
     ...
     */
    load: function load(urls, callback) {
      var that = this;
      if (typeof urls === 'string') this.urls.push(urls);else if (urls instanceof Array) this.urls = urls;
      this.images = [];
      ...
      for (var i = 0; i < this.length; i++) {
        (function () {
          ...
          image.onload = function () {
            that.loaded++;
            if (that.loaded === that.length) callback.call(that, that.images);
          };
     ...
     */
    get_proportions: function get_proportions(parameters) {
      // Errors
      var errors = [];
      if (typeof parameters.image_width === 'undefined' || parseInt(parameters.image_width, 10) === 0) errors.push('Image width must be specified');
      if (typeof parameters.image_height === 'undefined' || parseInt(parameters.image_height, 10) === 0) errors.push('Image height must be specified');
      ...
      parameters.coordinates = parameters.coordinates.toLowerCase(); // Alignment

      if (_typeof(parameters.alignment_x) === undefined || parameters.alignment_x !== 'left' && parameters.alignment_x !== 'center' && parameters.alignment_x !== 'right') parameters.alignment_x = 'center';
      if (_typeof(parameters.alignment_y) === undefined || parameters.alignment_y !== 'top' && parameters.alignment_y !== 'middle' && parameters.alignment_y !== 'bottom') parameters.alignment_y = 'middle'; // Functions

      var set_full_width = function set_full_width() {
      ...
      var set_full_height = function set_full_height() {
      ...
      if (parameters.fit_type === 'fill' || parameters.fit_type === 'full') {
        if (image_ratio < canvas_ratio) set_full_width();else set_full_height();
      } else if (parameters.fit_type === 'fit' || parameters.fit_type === 'i sits') {
        if (image_ratio < canvas_ratio) set_full_height();else set_full_width();
      } // Rounding
...
/***/ "../node_modules/imports-loader/index.js?APP=>entry.APP!./assets/js/modules/keyboard.class.js":
/*!*******************************************************************************************!*\
  !*** ../node_modules/imports-loader?APP=>entry.APP!./assets/js/modules/keyboard.class.js ***!
  \*******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
(function () {
  ...
  APP.TOOLS.Keyboard = APP.CORE.Event_Emitter.extend({
    ...
    static_instantiate: function static_instantiate() {
      if (APP.TOOLS.Keyboard.prototype.instance === null) return null;else return APP.TOOLS.Keyboard.prototype.instance;
    },
    ...
    init_events: function init_events() {
      ...
      window.onkeydown = function (e) {
        ...
        if (that.downs.indexOf(character) === -1) that.downs.push(character); // Trigger and prevend default if asked by return false on callback
      ...
      window.onkeyup = function (e) {
        var character = that.keycode_to_character(e.keyCode);
        if (that.downs.indexOf(character) !== -1) that.downs.splice(that.downs.indexOf(character), 1);
     ...
     * KEYCODE TO CHAR
     */
    keycode_to_character: function keycode_to_character(keycode) {
      var character = this.options.keycode_names[keycode];
      if (!character) character = String.fromCharCode(keycode).toLowerCase();
      return character;
    },
     ...
     * ARE DOWN
     */
    are_down: function are_down(keys) {
      var down = true;
...
/***/ "../node_modules/imports-loader/index.js?APP=>entry.APP!./assets/js/modules/mouse.class.js":
/*!****************************************************************************************!*\
  !*** ../node_modules/imports-loader?APP=>entry.APP!./assets/js/modules/mouse.class.js ***!
  \****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
(function () {
  ...
  APP.TOOLS.Mouse = APP.CORE.Event_Emitter.extend({
     ...
     */
    staticInstantiate: function staticInstantiate() {
      if (APP.TOOLS.Mouse.prototype.instance === null) return null;else return APP.TOOLS.Mouse.prototype.instance;
    },
    ...
    init_events: function init_events() {
      ...
      var mouse_wheel_handler = function mouse_wheel_handler(e) {
...
/***/ "../node_modules/imports-loader/index.js?APP=>entry.APP!./assets/js/modules/navigation.class.js":
/*!*********************************************************************************************!*\
  !*** ../node_modules/imports-loader?APP=>entry.APP!./assets/js/modules/navigation.class.js ***!
  \*********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
(function () {
  ...
  APP.TOOLS.Navigation = APP.CORE.Event_Emitter.extend({
     ...
     */
    staticInstantiate: function staticInstantiate() {
      if (APP.TOOLS.Navigation.prototype.instance === null) return null;else return APP.TOOLS.Navigation.prototype.instance;
    },
    ...
    init_events: function init_events() {
      // Support
      if (!this.history) return; // Context

      var that = this;

      window.onpopstate = function (e) {
        // Create result object
        var result = Object.create(e.state); // Prevent initial pop

        if (!result._prevent_default_tag) return; // Set title

        if (result.title) document.title = result.title; // State direction

        result.direction = result.id < that.state_id ? 'backward' : 'frontward';
        that.state_id = result.id; // Trigger
     ...
     * SET IN STATE
     */
    update_state: function update_state(data, replace_state) {
      // Support
      if (!this.history) return; // Tag

      data._prevent_default_tag = 1; // Replace the complete state or state not existing yet
    ...
    push: function push(state, url) {
      // Support
      if (!this.history) return; // Set title

      if (state.title) document.title = state.title; // State ID

      state.id = ++this.state_id; // Tag

      state.tag = 'test'; // Push state into history
...
/***/ "../node_modules/imports-loader/index.js?APP=>entry.APP!./assets/js/modules/password.class.js":
/*!*******************************************************************************************!*\
  !*** ../node_modules/imports-loader?APP=>entry.APP!./assets/js/modules/password.class.js ***!
  \*******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
(function () {
  ...
  APP.COMPONENTS.Password = APP.CORE.Event_Emitter.extend({
     ...
     */
    init_events: function init_events() {
      var that = this; // Close click event
     ...
     * ACTIVATE
     */
    activate: function activate(url, direction) {
      var that = this; // Save url and direction
...
/***/ "../node_modules/imports-loader/index.js?APP=>entry.APP!./assets/js/modules/project.class.js":
/*!******************************************************************************************!*\
  !*** ../node_modules/imports-loader?APP=>entry.APP!./assets/js/modules/project.class.js ***!
  \******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
(function () {
  ...
  APP.COMPONENTS.Project = APP.CORE.Event_Emitter.extend({
    ...
    init: function init(options) {
      ...
      this.$.lines_resize = this.$.lines.not('.line-to-screen-size'); // this.$.illustrations = this.$.lines.find( '.illustration' );
     ...
     * INIT PAGINATION
     */
    init_pagination: function init_pagination() {
      var that = this;
      this.pagination = {
        $: {}
      };
    ...
    update_line: function update_line(index, count, direction) {
      // To top
      if (index > 0) this.$.to_top.removeClass('hidden');else this.$.to_top.addClass('hidden'); // // Links
      // if( index === count - 1 )
...
/***/ "../node_modules/imports-loader/index.js?APP=>entry.APP!./assets/js/modules/ticker.class.js":
/*!*****************************************************************************************!*\
  !*** ../node_modules/imports-loader?APP=>entry.APP!./assets/js/modules/ticker.class.js ***!
  \*****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
(function () {
  ...
  APP.TOOLS.Ticker = APP.CORE.Event_Emitter.extend({
     ...
     */
    staticInstantiate: function staticInstantiate() {
      if (APP.TOOLS.Ticker.prototype.instance === null) return null;else return APP.TOOLS.Ticker.prototype.instance;
    },
    ...
    run: function run() {
      ...
      var loop = function loop() {
        if (that.running) window.requestAnimationFrame(loop);
        that.tick();
      };
...
/***/ "../node_modules/imports-loader/index.js?APP=>entry.APP,Hammer=hammerjs,FastClick=fastclick,Q=q!./assets/js/modules/app.class.js":
/*!******************************************************************************************************************************!*\
  !*** ../node_modules/imports-loader?APP=>entry.APP,Hammer=hammerjs,FastClick=fastclick,Q=q!./assets/js/modules/app.class.js ***!
  \******************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
(function () {
  ...
  APP.CORE.App = APP.CORE.Abstract.extend({
     ...
     * INIT HAMMER
     */
    init_hammer: function init_hammer() {
      var that = this;
      var hammertime = new Hammer(document.body);
      hammertime.on('swipe', function (e) {
        var index = that.index; // Home

        if (that.page.type === 'home') {
          // Right
          if ((window.orientation === 0 || window.orientation === 180) && e.direction === Hammer.DIRECTION_RIGHT || (window.orientation === -90 || window.orientation === 90) && e.direction === Hammer.DIRECTION_DOWN) {
            that.go_to_line(index - 1);
          } // Left
          else if ((window.orientation === 0 || window.orientation === 180) && e.direction === Hammer.DIRECTION_LEFT || (window.orientation === -90 || window.orientation === 90) && e.direction === Hammer.DIRECTION_UP) {
              that.go_to_line(index + 1);
            }
        } // Project
      ...
      this.browser.on('breakpoint', function (current_breakpoint, previous_breakpoint) {
        if (current_breakpoint.name === 'small') hammertime.get('swipe').set({
          direction: Hammer.DIRECTION_ALL,
          enable: false
        });else hammertime.get('swipe').set({
          direction: Hammer.DIRECTION_ALL
        });
      });
    },
     ...
     * INIT KEYBOARD
     */
    init_keyboard: function init_keyboard() {
      var that = this;
      this.keyboard.on('down', function (code, character) {
        switch (character) {
          ...
          case 'esc':
            // Close menu
            if (that.header.active) that.header.deactivate(); // Close project
            else if (that.page.type === 'project') that.page.$.main.find('a.close').first().trigger('click');
            break;
        ...
        if (['down', 'j', 'esc', 'up', 'k', 'space', 'right', 'left'].indexOf(character) !== -1 || character === 'enter' && !that.password.active) return false;
      });
    },
     ...
     * INIT PAGE
     */
    init_page: function init_page(page_name) {
      var _this = this;
      ...
      if (this.page) {// Tracking
        // if( ga )
        //     ga( 'send', 'pageview' );
      }

      this.page = page; // Fast click

      FastClick.attach(document.body);
      jQuery('.about-trigger').click(function () {
        _this.header.toggle();
      });
    },
     ...
     * INIT PASSWORD
     */
    init_password: function init_password() {
      var that = this;
     ...
     * INIT HEADER
     */
    init_header: function init_header() {
      var that = this;
      this.header = new APP.COMPONENTS.Header(); // Header project link click
     ...
     * INIT AJAX
     */
    init_ajax: function init_ajax($container) {
      var that = this;
      this.ajax = {};
      this.ajax.$links = $();
     ...
     * UPDATE AJAX
     */
    update_ajax: function update_ajax($container) {
      var that = this;
      $container = $container || $('body'); // Remove previous event listener

      this.ajax.$links.off('click.ajax'); // Find ajax links

      this.ajax.$links = $container.find('a.ajax'); // Ajax links click event
     ...
     * UPDATE IMAGES
     */
    update_images: function update_images($container) {
      var that = this;
     ...
     * LOAD
     */
    load: function load(url, direction, from_pop) {
      var that = this; // Close menu

      if (this.header.active) this.header.deactivate();
      ...
      this.can_navigate = false; // Default

      direction = direction || 'from-right'; // Prepare columns

      var $column = $('<div class="column">');
      $column.css({
        left: direction === 'from-right' ? '100%' : '-100%'
      }); // Ajax call
      ...
      Q.allSettled([ajax_promise.promise] // animation_promise.promise
      ).then(function (res) {
        res = res[0].value;

        if (res !== 'error') {
          that.$.columns.addClass('animated'); // Wait a frame

          window.setTimeout(function () {
            res = jQuery(jQuery.parseHTML(res)).find('div.page'); // Set column

            $column.append(res.clone());
            that.$.columns.append($column); // Update ajax

            that.update_ajax(); // Update images

            that.update_images($column); // Deactivate page

            if (that.page) that.page.active = false; // Navigation push

            var title = $column.find('input[type=text].title').val();
            document.title = title;
            if (!from_pop) that.navigation.push({
              title: title
            }, url); // Init page

            var page = $column.find('input[type=text].page').val();
            that.init_page(page); // Update lines

            that.$.lines = $column.find('.line'); // Specified hashtag
            ...
            window.setTimeout(function () {
              ...
              that.$.columns.find('.column').not($column).remove(); // Allow navigation
     ...
     * INIT COLUMNS
     */
    init_columns: function init_columns() {
     ...
     * INIT LINES
     */
    init_lines: function init_lines() {
      var that = this;
      ...
      this.go_to_line(this.index, 30); // Wheel

      this.mouse.on('wheel', function (delta) {
        // Set variables
        var index = that.index + (delta < 0 ? 1 : -1);
        that.go_to_line(index); // if( that.browser.width >= 900 )
        // {
        //     return false;
        // }
      });
    },
    go_to_line: function go_to_line(index, duration) {
      duration = duration || 1060; // // Prevent on project when width < 900
      // if( this.browser.width < 900 )
      // {
      ...
      var that = this,
          direction = that.index < index ? 'down' : 'up'; // Save in history state

      this.navigation.update_state({
        line: index
      }); // Prevent scroll

      this.can_scroll = false; // Show all lines

      this.$.lines.show(); // Wait a frame (RAF not working)
      ...
      window.setTimeout(function () {
        ...
        that.$.lines.each(function () {
          ...
          if (i < index) {
            ...
            classes = 'current';
            if ($line.hasClass('dark')) $('body').addClass('dark');else $('body').removeClass('dark');
          }
        ...
        window.setTimeout(function () {
          ...
          that.can_scroll = true;
        }, duration); // Update in page

        if (that.page && that.page.active) that.page.update_line(index, that.$.lines.length, direction); // Save new index
...
/***/ "../node_modules/mini-css-extract-plugin/dist/loader.js!../node_modules/css-loader/index.js!../node_modules/postcss-loader/lib/index.js?!../node_modules/sass-loader/lib/loader.js!./assets/scss/main.scss":
/*!********************************************************************************************************************************************************************************************************!*\
  !*** ../node_modules/mini-css-extract-plugin/dist/loader.js!../node_modules/css-loader!../node_modules/postcss-loader/lib??ref--7-3!../node_modules/sass-loader/lib/loader.js!./assets/scss/main.scss ***!
  \********************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
__webpack_require__(/*! tinyscrollbar */ "../node_modules/tinyscrollbar/lib/jquery.tinyscrollbar.js");

__webpack_require__(/*! ./modules/class.js */ "./assets/js/modules/class.js");

__webpack_require__(/*! expose-loader?entry!./modules/app.js */ "../node_modules/expose-loader/index.js?entry!./assets/js/modules/app.js-exposed");

__webpack_require__(/*! imports-loader?APP=>entry.APP!./modules/abstract.class.js */ "../node_modules/imports-loader/index.js?APP=>entry.APP!./assets/js/modules/abstract.class.js");

__webpack_require__(/*! imports-loader?APP=>entry.APP!./modules/event_emitter.class.js */ "../node_modules/imports-loader/index.js?APP=>entry.APP!./assets/js/modules/event_emitter.class.js");

__webpack_require__(/*! imports-loader?APP=>entry.APP,Hammer=hammerjs,FastClick=fastclick,Q=q!./modules/app.class.js */ "../node_modules/imports-loader/index.js?APP=>entry.APP,Hammer=hammerjs,FastClick=fastclick,Q=q!./assets/js/modules/app.class.js");

__webpack_require__(/*! imports-loader?APP=>entry.APP!./modules/header.class.js */ "../node_modules/imports-loader/index.js?APP=>entry.APP!./assets/js/modules/header.class.js");

__webpack_require__(/*! imports-loader?APP=>entry.APP!./modules/password.class.js */ "../node_modules/imports-loader/index.js?APP=>entry.APP!./assets/js/modules/password.class.js");

__webpack_require__(/*! imports-loader?APP=>entry.APP!./modules/home.class.js */ "../node_modules/imports-loader/index.js?APP=>entry.APP!./assets/js/modules/home.class.js");

__webpack_require__(/*! imports-loader?APP=>entry.APP!./modules/project.class.js */ "../node_modules/imports-loader/index.js?APP=>entry.APP!./assets/js/modules/project.class.js");

__webpack_require__(/*! imports-loader?APP=>entry.APP!./modules/mouse.class.js */ "../node_modules/imports-loader/index.js?APP=>entry.APP!./assets/js/modules/mouse.class.js");

__webpack_require__(/*! imports-loader?APP=>entry.APP!./modules/keyboard.class.js */ "../node_modules/imports-loader/index.js?APP=>entry.APP!./assets/js/modules/keyboard.class.js");

__webpack_require__(/*! imports-loader?APP=>entry.APP!./modules/browser.class.js */ "../node_modules/imports-loader/index.js?APP=>entry.APP!./assets/js/modules/browser.class.js");

__webpack_require__(/*! imports-loader?APP=>entry.APP!./modules/css.class.js */ "../node_modules/imports-loader/index.js?APP=>entry.APP!./assets/js/modules/css.class.js");

__webpack_require__(/*! imports-loader?APP=>entry.APP!./modules/images.class.js */ "../node_modules/imports-loader/index.js?APP=>entry.APP!./assets/js/modules/images.class.js");

__webpack_require__(/*! imports-loader?APP=>entry.APP!./modules/ticker.class.js */ "../node_modules/imports-loader/index.js?APP=>entry.APP!./assets/js/modules/ticker.class.js");

__webpack_require__(/*! imports-loader?APP=>entry.APP!./modules/navigation.class.js */ "../node_modules/imports-loader/index.js?APP=>entry.APP!./assets/js/modules/navigation.class.js");
...
(function () {
  ...
  window.copy = function (object) {
    ...
    if (!object || _typeof(object) !== 'object' || typeof HTMLElement !== 'undefined' && object instanceof HTMLElement || object instanceof Class || typeof THREE !== 'undefined' && object instanceof THREE.Object3D || typeof jQuery !== 'undefined' && object instanceof jQuery) {
      return object;
  ...
  window.merge = function (original, extended) {
    for (var key in extended) {
      ...
      if (_typeof(ext) !== 'object' || ext instanceof HTMLElement || ext instanceof Class || typeof THREE !== 'undefined' && ext instanceof THREE.Object3D || typeof ext !== 'undefined' && ext instanceof jQuery) {
        original[key] = ext;
      } else {
...
var content = __webpack_require__(/*! !../../../node_modules/mini-css-extract-plugin/dist/loader.js!../../../node_modules/css-loader!../../../node_modules/postcss-loader/lib??ref--7-3!../../../node_modules/sass-loader/lib/loader.js!./main.scss */ "../node_modules/mini-css-extract-plugin/dist/loader.js!../node_modules/css-loader/index.js!../node_modules/postcss-loader/lib/index.js?!../node_modules/sass-loader/lib/loader.js!./assets/scss/main.scss");
...
/******/ });
//# sourceMappingURL=main.4f193908dd31dfba258a.js.map